...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', 
    ...
    $scope.keypressHandle = function(e){
        ...
        if(e.ctrlKey || e.metaKey){
            ...
            e.preventDefault();
            var _states = $scope.stages[$scope.currentStage].states;
            switch( e.which ) {
                case 65:
    ...
    $scope.getCurrentLayerInfo = function(){
        ...
        if( objects.length > 1 ){
            ...
            if( object ){
                ...
                ['lockMovementX', 'lockMovementY', 'lockScalingX', 'lockScalingY', 'lockRotation', 'lockUniScaling', 'selectable'].forEach(function(key){
    ...
    $scope.insertCanvaTypo = function(url){
...
//        });
    ...
    console.log(_canvas.getActiveObject().get('left'));
    console.log(_canvas.getActiveObject().getBoundingRect());
        $scope.renderStage();
