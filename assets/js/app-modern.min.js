...
//                            }
    ...
    $scope.onClickStage = function( $event ){return;
        /*
         * Deactive all layer if click outer canvas 
         * Hide context menu
         * Store stages
         */        
        if(angular.element($event.currentTarget).hasClass('stage')){
            $scope.deactiveAllLayer();
            /* store all stages */    
    ...
    $scope.addRulerGuideLine = function( $event, direction ){
        ...
        top = $event.pageY - stagePos.top - 3,
        left = $event.pageX - stagePos.left - 3;
       ...
       restrict: "AE",
        ...
        link: function( scope, element, attrs ){
            $timeout(function(){
                ...
                }).on('mouseup', function(event){console.log(222);
