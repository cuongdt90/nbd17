...
>>>>>>> b00b0e85781e0987d92e2dc9fbec37cf65493029
        var position = {
            ht: {top: -9999},
            hb: {top: -9999},
            hc: {top: -9999},
...
<<<<<<< HEAD
    $scope.getCurrentLayerinfo = function(){
        ...
        var objects = _canvas.getActiveObjects();
console.log(object);
console.log(objects);
        if( object ){
    ...
    $scope.getCurrentLayerInfo = function(){
        ...
        if( objects.length > 1 ){
            ...
            if( object ){
                ...
                $scope.stages[$scope.currentStage].states.oos  = angular.isDefined(object.get('oos')) ? object.get('oos') : false;
...
//console.log(_canvas.getActiveObject());
    ...
    $scope.addText = function(content, type){
        ...
        if( textType == 'Textbox' ) angular.extend(textObj, {width: 300, textAlign: 'center'});
        function addText(){
    ...
    $scope.setLayerAttribute = function(type, value, item_index, layer_index){
        ...
        switch(type){
            ...
            case 'selectable':
                ...
                break;
            case 'lockScalingX':
                var controlVisible = itemType == 'textbox' ? ['ml', 'mr'] : ['tl', 'tr', 'bl', 'br', 'ml', 'mr'];
                controlVisible.forEach(function(key){
                    item.setControlVisible(key, !value);
                });
                break;
            case 'lockScalingY':
                var controlVisible = itemType == 'textbox' ? [] : ['tl', 'tr', 'bl', 'br', 'mt', 'mb'];
                controlVisible.forEach(function(key){
                    item.setControlVisible(key, !value);
                });
                break;
