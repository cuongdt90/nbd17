...
//            document.fonts.load('italic bold 1px '+fontName, 'a').then(function(){console.log(33333);
...
//        });
    ...
    $scope.setTextAttribute = function(type, value, extra_option){
        ...
        if( type.indexOf("font") > -1 ){ 
            document.fonts.load(_states.text.fontStyle+' '+_states.text.fontWeight+' 1px '+_states.text.fontFamily, 'a').then(function(){
