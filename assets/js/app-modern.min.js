...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window',function($scope, FabricWindow, $window){
    $scope.stages = [
        {
            config: {
...
//        console.log(item);
    ...
    $scope.clearStage = function(){
        //todo something before clear stage
        $scope._clearStage();
    };
    $scope._clearStage = function(){
...
//            items = _canvas.getActiveObjects();    
//        items.forEach(function( item ){
//            item.set({opacity: $scope.stages[$scope.currentStage].states.opacity});
//        });        
    };
    /* Text */
