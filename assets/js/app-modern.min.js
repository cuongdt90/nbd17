...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document',
    ...
    $scope.initSettings = function(){
        ...
        $scope.resource = {
            ...
            globalTemplate: {filter: {perPage: 10, currentPage: 1, totalPage: 0}, data: [], init: true, onload: false}     
        };
    ...
    $scope.changeGlobalTemplate = function(){
        $scope.toggleStageLoading();
        $scope.resource.globalTemplate = {filter: {perPage: 10, currentPage: 1, totalPage: 0}, data: [], init: false, onload: false} 
        $scope.loadGlobalTemplate($scope.templateCat);
    };
            ...
            if( !$scope.isTemplateMode || ($scope.isTemplateMode && $scope.settings.task == 'edit') ){
                $timeout(function(){
                    if( angular.isDefined($scope.settings.product_data.design) ){
                        ...
                        if( angular.isDefined( config.scale ) ){
