...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'NBDDataFactory', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document',
    ...
    $scope.loadGlobalTemplate = function(cid){
        ...
        $http({
            method: 'GET',
            url: 'http://localhost/nbmedia/v1/template?limit=20&category=' + cid + '&search=' + search + '&start=' + ($scope.resource.globalTemplate.filter.currentPage-1) * 20
...
//            }, 100);            
    ...
    $scope.addStage = function(){
        var new_stage = {};              
        angular.copy($scope.stages[$scope.stages.length - 1], new_stage);
