...
//        }
    ...
    $scope.addImage = function(url, params) {
        //$scope.zoom = 1;
        $scope.zoomCanvas();
        url ='https://pixabay.com/get/eb37b80a2cf7003ecd0b4702e548418be272e3d210b1134793f1.jpg';
    ...
    $scope.callPixabayApi = function(p){
        var xhr = new XMLHttpRequest();
        var per_page = 30;
        xhr.open('GET', 'https://pixabay.com/api/?key=27347-23fd1708b1c4f768195a5093b&response_group=high_resolution&lang='+lang+'&safesearch='+safesearch+'&image_type=photo&per_page='+per_page+'&page='+p+'&search_term='+encodeURIComponent($scope.pixabay_key));        
    };
