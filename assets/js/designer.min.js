...
//        if( 1 /*$scope.currentVariant.info[$scope.currentSide.id].source.area_design_type == "2" */){
...
//            $scope.canvas.backgroundColor = null;
//        };   
        $scope.canvas.calcOffset();
        $scope.canvas.setZoom($scope.zoom);
        $scope.drawCanvas()
        ...
        _.each(fonts, function(font){
            if(font.type == "google"){
                ...
                if (!isFontAvailable(font.alias)) {
                    var font_url = font.url; if(!(font_url.indexOf('http') > -1)) font_url = assets_font_url + font.url;
...
//        if($scope.currentVariant.info[p.id]["source"]['area_design_type'] == "2"){
//            $scope.canvas.clipTo = function(ctx) {
...
//        };
    ...
    $scope.saveDesign = function(orientation) {
        ...
        $scope.zoomCanvas();
        $scope.drawCanvas();
        var json = canvas.toJSON(['itemId', 'selectable', 'lockMovementX', 'lockMovementY', 'lockScalingX', 'lockScalingY', 'lockRotation', 'rtl', 'elementUpload', 'forceLock', 'isBg']);      
...
//        };          
    ...
    $scope.setShapeColor = function(e) {
        ...
        console.log($scope.editable.type);
    ...
    $scope.init = function() {
        ...
        if( angular.isUndefined( NBDESIGNCONFIG['product_data'].config) || angular.isUndefined( NBDESIGNCONFIG['product_data'].config.initNoPage ) ){
...
//            a.click() 
        ...
        //$scope.addTextBox();
       // console.log($scope.svgs);
       console.log(_.flatten(colorPalette));
    };
        ...
        jQuery.ajax({
            ...
            if (_data.flag == "success") {
                ...
                if( NBDESIGNCONFIG['ui_mode'] == "1" ){
                    ...
                    nbd_window.NBDESIGNERPRODUCT.show_design_thumbnail(_data.image, NBDESIGNCONFIG['task'], _data.folder);
