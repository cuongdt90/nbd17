...
angular.module("app").controller("DesignerController", function($scope, PatternService, ProductService, localStorageService, FontService, ArtService, QrcodeService, $interval, $upload, $timeout, LanguageService, AdminTemplateService) {
    ...
    $scope.iid = "images";
    $scope.qrCodeContent = NBDESIGNCONFIG['nbdesigner_default_qrcode'];
    ...
    $scope.initStage = function(data){
        ...
        $scope.uploadSetting = data.upload;  
        ...
        _.each(fonts, function(font){
            if(font.type == "google"){
                ...
                if (!isFontAvailable(font.name)) {
                    ...
                    css += "src: local('\u263a'),";
                    css += "url('" + assets_font_url + font.url + "') format('" + font.type + "')";
                    css += "}";
                    css += "</style>";
...
//        };
    ...
    $scope.saveCart = function(){
        ...
        NBDESIGNERCART.save_cart($scope.dataCustomerDesign, $scope.canvases, fonts, config, files);        
    };
    ...
    $scope.onFileUploadSelect = function( $files ){
        ...
        if( file.size > maxsize ){
            ...
            alert($scope.errorUpload);
        }else if($scope.uploadSetting.allow_type.indexOf(ext) === -1 || $scope.uploadSetting.disallow_type.indexOf(ext) > 0){
...
var NBDESIGNERCART = {
    build_form: function(data_img, data_json, fonts, config, action){
    ...
    save_design : function(data_img, data_json, fonts, config){
        ...
        var fd = this.build_form(data_img, data_json, fonts, config, action);
        jQuery.ajax({
            url: NBDESIGNCONFIG['ajax_url'],
            method: "POST",   
            processData: false,
    ...
    save_cart : function(data_img, data_json, fonts, config, files){
        show_indicator(); 
