...
(function ($) {
        ...
        sideBar: {
            ...
            tabProductTemplate: function () {
                ...
                $productImg.on('click', function () {
                    ...
                    // nbdItemDropdown.clear();
                    // nbdItemDropdown.init();
    ...
    var nbdItemDropdown = {
        ...
        main: function () {
            var $items = $('.nbd-sidebar .nbd-items-dropdown .items')
            var $item = $('.nbd-sidebar .nbd-items-dropdown .items .item');
            var $mainItems = $('.nbd-sidebar .nbd-items-dropdown .main-items');
            var $resultLoaded = $('.nbd-sidebar .nbd-items-dropdown .result-loaded');
            var $galleryItem = $('.nbd-sidebar .nbd-items-dropdown .nbdesigner-gallery');
            var noItem = $item.length;
            var noItemRow = parseInt(noItem / 2);
            var itemHeight = $item.outerHeight() + 10;
            var $loadingGif = $('.nbd-sidebar .nbd-items-dropdown .loading-photo');
            var isMasonry = false;

            nbdItemDropdown.initPositionItem($items, $item);
            // set height for content cate
            $mainItems.css({
            ...
            $item.on('click', function () {
                ...
                if (!$mainItems.hasClass('active-expanded')) {
                    ...
                    $resultLoaded.show();
                    $galleryItem.show();
                    var item = nbdItemDropdown.getImageItem();
                    for (var i=0;i<10;i++) {
                        $galleryItem.append(item);
                    }

                    var nextAllItem = $('.nbd-sidebar .nbd-items-dropdown .items .item:nth-child(' + indexItemRow * 2 + ')').nextAll();
    ...
    //         var isMasonry = false;
    //
    //         this.initPositionItem($items, $item);
    //         // set height for content cate
    //         $mainItems.css({
    //             'height': noItemRow * itemHeight + 'px'
    //         });
    ...
    //             }else {
    //                 $mainItems.removeClass('active-expanded');
    //                 sefl.initPositionItem($items, $item);
    //                 $resultLoaded.find('.nbdesigner-gallery').empty();
    //                 $resultLoaded.removeClass('loaded');
    //                 $galleryItem.hide();
    //             }
    //         });
    //     };
    //     this.initPositionItem = function (items,item) {
    //         // TODO check has el
    //         var leftItem = items.width() / 2;
    //         var topItem = item.height() + 20;
    //         item.show();
