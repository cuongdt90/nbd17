        ...
        clickOutside: function () {
            ...
            $win.on("click", function(event){
                ...
                if ($colorPallette.has(event.target).length == 0 && !$colorPallette.is(event.target) && !$('.nbd-show-color-palette span').is(event.target)) {
                    ...
                    $('.nbd-show-color-palette').removeClass('active');
                }
...
//                });
        ...
        showPopup: function () {
            ...
            $showPopupShare.on('click', function () {
                ...
                $nbdPopupShare.find('.overlay-main').addClass('active');
                setTimeout(function () {
                    $nbdPopupShare.find('.overlay-main').removeClass('active');
                }, 800);
            });
...
//                        $resultLoaded.find('.nbdesigner-gallery').empty();
    ...
    $(document).ready(function () {
        ...
        $('#toolbar-font-size-dropdown,#toolbar-font-familly-dropdown, .nbd-sidebar .tab-scroll, .nbd-perfect-scroll').perfectScrollbar();
