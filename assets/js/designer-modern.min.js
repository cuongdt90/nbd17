        ...
        sideBar: {
            ...
            tabPhto: {
                ...
                main: function () {
                    ...
                    $categories.closest('.content-category').css({
                    ...
                    $category.on('click', function () {
                        ...
                        // }else{
                        //     $categories.parent().find('.pointer').css({
                        //         'left': (widthCa / 2) * (indexCa % 3 + 2) + 'px'
                        //     });
                        // }

                        // Set height for categories
                        var $contentCa = $category.closest('.content-category');
                        $contentCa.css({
                            'height': indexCaRow * 132 + 'px'
                        });

                        if (!$contentCa.hasClass('active-expanded')) {

                            $resultLoaded.show();
                            $contentCa.addClass('active-expanded');
                            $gallery.empty();
                            ...
                            $gallery.imagesLoaded()
                                .always( function( instance ) {
                                    ...
                                    $gallery.find('.nbdesigner-item').each(function (i) {
                                        ...
                                        $(this).addClass('slideInDown animated animate' + animate);
                                    });

                                    // Set position for category
                                    var heightResult = $resultLoaded.outerHeight();
                            ...
                            $contentCa.removeClass('active-expanded');
                ...
                getImageItem: function () {
                    var src = 'http://192.168.9.175/online-design/wp-content/plugins/web-to-print-online-designer/assets/images/mobile.png';
