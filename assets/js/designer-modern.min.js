...
//                });
        ...
        showPopup: function () {
            ...
            $('.nbd-show-popup-share').on('click', function () {
                ...
                setTimeout(function () {
                    $('.nbd-popup.popup-share').find('.overlay-main').removeClass('active');
                }, 800);
            });
            ...
            // popup import file
            // $('.nbd-main-bar .item-import-file').on('click', function () {
            //     $('.nbd-popup.popup-import-file').nbShowPopup();
            // });
    ...
    $.fn.nbToasts = function (text) {
        return this.each(function () {
            ...
            var htmlToast = '<div class="animate300 animated nbSlideInUp toast">' +
                '<span>'+ text +'</span>' +
                '<i class="icon-nbd icon-nbd-clear nbd-close-toast"></i>' +
                '</div>';
            var $toast = $(htmlToast);
