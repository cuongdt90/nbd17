...
//        }
    ...
    $scope.callPixabayApi = function(){
        if( $scope.pixabayPage <= $scope.pixabayPages  ){
            ...
            jQuery.get('https://pixabay.com/api/?key=27347-23fd1708b1c4f768195a5093b&response_group=high_resolution&image_type=photo&per_page='+$scope.pixabayPerPage+'&page='+$scope.pixabayPage+'&search_term='+encodeURIComponent($scope.pixabay_key), function(){
            }).done(function(data){
