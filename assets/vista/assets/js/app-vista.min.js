...
//            }
    ...
    $scope.setPositionToolbox = function () {
        ...
        var $vista = jQuery('.nbd-vista'),
            $stage = jQuery('.nbd-vista .stage'),
            $stageActive = null,
            $stageMainActive = null,
            $stageMain = jQuery('.nbd-vista .stage .stage-main'),
            $layout = jQuery('.nbd-vista .nbd-layout');

        $stage.each(function (i) {
            var idStage = jQuery(this).attr('id');
            idStage = idStage.substr(idStage.length - 1);
            if (idStage == $scope.currentStage) {
                $stageActive = jQuery(this);
                $stageMainActive = jQuery(this).find('.stage-main');
                return false;
            }
        });
