...
//            }
    ...
    $scope.setPositionToolbox = function () {
        ...
        var $stageMain = jQuery('.nbd-vista .stage-main'),
        ...
        var ratioScale = stage.states.scaleRange[stage.states.currentScaleIndex].ratio,
            paddingL = $stageMain.offset().left - $layout.offset().left,
            paddingT = $stageMain.offset().top - $layout.offset().top,
            pLeft = 0,
            pTop = 0;


        stage.states.toolbarStyle = {
            top: bound.top + paddingT + bound.height + stage.config.top * ratioScale + 7,
            left: bound.left + bound.width/2 + paddingL + stage.config.left * ratioScale
        };
