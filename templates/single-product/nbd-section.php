...
<div class="nbdesigner_frontend_container">
    <p>
        <a class="button alt nbdesign-button <?php echo $class; ?>" id="triggerDesign" >
...
<div style="position: fixed; top: 0; left: 0; right: 0; z-index: 999999; opacity: 0" id="container-online-designer" data-iframe="<?php echo $src; ?>">
