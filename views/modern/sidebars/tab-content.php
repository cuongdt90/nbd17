    ...
    <div class="tab" ng-if="settings['nbdesigner_enable_text'] == 'yes'" id="tab-typography">
        <div class="tab-main tab-scroll">
            <div class="typography-head">
                <span class="text-guide" style="color: #4F5467; margin-bottom: 20px;display: block;"><?php _e('Click to add text','nbd-online-design'); ?></span>
                <div class="head-main">
                    <span class="text-heading" style="color: #4F5467; display: block; font-size: 40px; font-weight: 700"><?php _e('Add heading','web-to-print-online-designer'); ?></span>
                    ...
                    <span class="text-body" style="display: block;color: #4F5467"><?php _e('Add subheading','nbd-online-design'); ?></span>
                </div>
            </div>
                ...
                <div class="main-items">
                    <div class="items">
                        <div class="item" data-type="animal" data-api="true">
                            <div class="main-item">
                                <div class="item-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M19 5l5 5.89V3m5 2l-5 5.89" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke="#455a64" stroke-miterlimit="10"/><path d="M24 10c-9.973 0-18 8.973-18 16.398C6 33.898 14.074 40 24 40s18-6.102 18-13.602C42 18.973 33.973 10 24 10z" fill="#ffd600"/><path d="M24 13c-9.973 0-18 5.973-18 13.398C6 33.898 14.074 40 24 40s18-6.102 18-13.602C42 18.973 33.973 13 24 13z" fill="#ffc107"/><path d="M6.137 28c.043.285.101.566.172.848.03.129.054.261.09.39.093.328.21.653.331.973.086.219.184.434.286.652a12.654 12.654 0 0 0 1.656 2.629C11.84 37.387 17.516 40 24 40s12.16-2.613 15.328-6.508c.594-.726 1.09-1.5 1.496-2.304.055-.11.11-.22.16-.329.102-.214.2-.43.286-.648.12-.32.238-.645.332-.973.035-.129.058-.261.09-.39.07-.282.128-.563.171-.848.02-.129.04-.254.055-.383.047-.398.082-.805.082-1.219-3.188 4.227-4.074 2.055-4.074 2.055-.824-2.898-3.574-3.562-5.586-4.047-1.738-.422-2.828-.738-3.297-1.586-.734-1.328-1.969-3.55-4.863-3.812l-.18-.016-.18.016c-2.894.262-4.129 2.484-4.863 3.812-.469.848-1.559 1.164-3.297 1.586-2.012.485-4.762 1.149-5.586 4.047-.152.543-1.699 1.527-4.074-2.055A10.41 10.41 0 0 0 6.137 28z" fill="#ffa726"/><path d="M36 29c-.984-3.477-6.805-1.781-8.707-5.21-.676-1.22-1.48-2.626-3.293-2.79-1.813.164-2.617 1.57-3.293 2.79C18.805 27.222 12.984 25.522 12 29c-.984 3.477-2 6.2-2 10 0 7.02 8.188 7 14 7 5.813 0 14 .02 14-7 0-3.8-1.016-6.523-2-10z" fill="#ffe0b2"/><path d="M18.977 21a3 3 0 1 1-6.002-.002 3 3 0 0 1 6.002.002z" fill="#fff"/><path d="M15.977 20a1 1 0 1 1-2.001.001 1 1 0 0 1 2-.001z" fill="#445963"/><path d="M34.977 21a3 3 0 1 1-6.002-.002 3 3 0 0 1 6.002.002z" fill="#fff"/><path d="M31.977 20a1 1 0 1 1-2.001.001 1 1 0 0 1 2-.001z" fill="#445963"/><path d="M26 27v1m-4-1v1" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke="#795548" stroke-miterlimit="10"/></svg>
                                </div>
                                <div class="item-info">
                        ...
                        <div class="item" data-type="misc" data-api="true">
                            <div class="main-item">
                                <div class="item-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><path d="M4.511 38.5c.263-6.11 5.315-11 11.489-11h8c6.174 0 11.227 4.89 11.489 11H4.511z" fill="#c2e8ff"/><path d="M24 28c5.729 0 10.448 4.401 10.955 10H5.045C5.552 32.401 10.271 28 16 28h8m0-1h-8C9.373 27 4 32.373 4 39h32c0-6.627-5.373-12-12-12z" fill="#7496c4"/><path d="M20 30.266l-4.702 2.957-1.567-5.485c.768-.158 1.53-.238 2.269-.238h8c.739 0 1.501.08 2.27.237l-1.567 5.485L20 30.266z" fill="#c2e8ff"/><path d="M24 28c.535 0 1.083.044 1.637.131l-1.232 4.314-3.872-2.435-.533-.335-.532.335-3.872 2.435-1.232-4.314A10.543 10.543 0 0 1 16 28h8m0-1h-8c-1 0-1.966.136-2.895.366L15 34l5-3.144L25 34l1.895-6.634A12.015 12.015 0 0 0 24 27z" fill="#7496c4"/><polygon points="15.5,27.819 15.5,22.5 24.5,22.5 24.5,27.819 20,31.364" fill="#deb974"/><path d="M24 23v4.577l-4 3.151-4-3.151V23h8m1-1H15v6.062L20 32l5-3.938V22z" fill="#967a44"/><polygon points="22.601,29.619 20,30.305 17.401,29.623 19,33 17,39 23,39 21,33" fill="#4e7ab5"/><path d="M27.143 19.214c-1.3 0-2.356-1.058-2.356-2.357s1.057-2.357 2.356-2.357c1.963 0 2.357.538 2.357 1.405 0 1.414-1.165 3.309-2.357 3.309zm-14.286 0c-1.192 0-2.357-1.895-2.357-3.31 0-.867.395-1.405 2.357-1.405a2.358 2.358 0 0 1 0 4.715z" fill="#deb974"/><path d="M27.143 15C29 15 29 15.481 29 15.905c0 1.234-1.041 2.81-1.857 2.81a1.859 1.859 0 0 1-1.857-1.857A1.86 1.86 0 0 1 27.143 15m-14.286 0c1.024 0 1.857.833 1.857 1.857a1.859 1.859 0 0 1-1.857 1.857c-.816 0-1.857-1.575-1.857-2.81 0-.423 0-.904 1.857-.904m14.286-1a2.857 2.857 0 1 0 0 5.714c1.578 0 2.857-2.232 2.857-3.81C30 14.327 28.721 14 27.143 14zm-14.286 0C11.279 14 10 14.327 10 15.905s1.279 3.81 2.857 3.81a2.857 2.857 0 1 0 0-5.715z" fill="#967a44"/><path d="M20 26.5a2.464 2.464 0 0 1-1.642-.63l-.091-.08-.116-.03A7.486 7.486 0 0 1 12.5 18.5V9.202a3.316 3.316 0 0 1 3.312-3.313h8.375A3.317 3.317 0 0 1 27.5 9.202V18.5a7.486 7.486 0 0 1-5.651 7.26l-.116.03-.091.08c-.47.412-1.038.63-1.642.63z" fill="#f5ce85"/><path d="M24.187 6.389A2.816 2.816 0 0 1 27 9.202V18.5a6.988 6.988 0 0 1-5.275 6.776l-.233.059-.181.159c-.263.231-.703.506-1.311.506s-1.048-.275-1.311-.506l-.181-.159-.233-.059A6.988 6.988 0 0 1 13 18.5V9.202a2.816 2.816 0 0 1 2.813-2.813h8.374m0-1h-8.375A3.813 3.813 0 0 0 12 9.202V18.5c0 3.737 2.566 6.866 6.029 7.745.528.464 1.213.755 1.971.755s1.443-.291 1.971-.755C25.434 25.366 28 22.237 28 18.5V9.202a3.813 3.813 0 0 0-3.813-3.813z" fill="#967a44"/><path d="M27.5 17.5V14c0-3.636-3.033-5.582-3.163-5.663l-.398-.25-.275.383c-.085.118-2.119 2.887-6.514 2.887-1.15 0-4.65 0-4.65 3.643v2.5h-.179c-.436-.982-1.821-4.332-1.821-7.188 0-5.271 3.617-8.812 9-8.812 3.839 0 4.992 2.585 5.039 2.695l.131.303.33.002c1.671 0 4.5 1.162 4.5 5.515 0 2.623-1.407 6.393-1.838 7.485H27.5z" fill="#a6714e"/><path d="M19.5 2c3.483 0 4.538 2.297 4.577 2.385l.257.615H25c1.845 0 4 1.313 4 5.015 0 1.536-.507 3.498-1 5.043V14c0-3.909-3.258-5.999-3.397-6.087l-.801-.503-.547.772c-.019.027-1.941 2.674-6.105 2.674C13.733 10.857 12 12.251 12 15v.314c-.491-1.422-1-3.305-1-5.003C11 5.34 14.416 2 19.5 2m0-1C13.681 1 10 4.981 10 10.311 10 13.842 12 18 12 18h1v-3c0-2.668 2.024-3.143 4.15-3.143 4.73 0 6.922-3.097 6.922-3.097S27 10.599 27 14v4h1s2-4.768 2-7.985C30 5.498 27.123 4 25 4c0 0-1.253-3-5.5-3z" fill="#7a4f34"/></svg>
                                </div>
                                <div class="item-info">
                                    <span class="item-name" title="Business Card">Man</span>
                                </div>
                            </div>
                        </div>
                        <div class="item" data-type="Girl" data-api="true">
                            <div class="main-item">
                                <div class="item-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M39.375 28H45s-5.168-.582-1-7v-5l-2-1s-3.203 3.64-3.203 4.89c0 6.094.578 8.11.578 8.11z" fill="#424242"/><path d="M42 45v-2c0-3.3-2.7-6-6-6l-12.813-1.219A6.905 6.905 0 0 0 20 35h-9c-3.379.492-6 3.492-6 7v3z" fill="#d32f2f"/><path d="M20 28v4s.168 2.332-5 3c0 0 9.293 3.5 15.043 8 0 0-.137-5.938-.043-9 .074-2.45-10-6-10-6z" fill="#ffb74d"/><path d="M41.313 24.938c1.515 4.796-2.36 7.253-3.938 10.898C36.82 37.109 35.477 40 32 40c-2.39 0-3.793-1.875-5-3-.934-.867-5.328-3.344-6-7-.672-3.656-1-9-1-9l3-3h13l5-1 1 1v4.344c0 1.02-.23 2.082-.688 2.593z" fill="#ffcc80"/><path d="M44 17c-5.957-1.25-9.27-5-17-5-3.2 0-7.48 8.855-6.992 15.746C15.528 24.906 12 20.531 12 16c3.75-.875 4.73-4.11 6-6.215A13.989 13.989 0 0 1 30 3c7.73 0 14 6.27 14 14z" fill="#424242"/><path d="M42 18c-5.27-1.793-10.27-3-18-3-2.227 0-6.125 5.332-3 13-4.281 0-8.395-3.055-10.117-7.004.68-2.558 2.68-3.558 4.117-4.996 3.355-3.355 7.906-9 13-9 7.73 0 14 3.27 14 11z" fill="#424242"/><path d="M18 26l3 4h4s-6.793-2.313-1-11c0 0 7.957 1 8 1 1.043 0 2-1 2-1l4 1s2.031.031 3-2c0 0 .645 1.293 0 2h3l-4-9-18 2-4 6z" fill="#424242"/><path d="M33 26.438S32.23 24 30 24c-1.469 0-2.563.563-3 2 0 0 1.113 1 3 1s3-.563 3-.563z" fill="#fff"/><path d="M30 25c1.352 0 2.164.895 2.598 1.598.257-.09.402-.16.402-.16S32.23 24 30 24c-1.469 0-2.563.563-3 2 0 0 .129.11.348.246C27.898 25.367 28.824 25 30 25z" fill="#37474f"/><path d="M30.355 25.418a1.187 1.187 0 1 1-2.373.001 1.187 1.187 0 0 1 2.373-.001zm3.395-.438s-3.043-1.5-4.938-1.96c-.609-.145-2.812 0-2.812 0s.031-1.02 2.063-1.04c2.03-.023 6.136 2.145 5.687 3zm3.27.02l4.636-2.313s-.426 1.325-1.27 1.801c-.843.48-3.366.512-3.366.512z" fill="#37474f"/><path d="M37 26s.895-2 2.613-2c.356 0 1.117.125 1.387 1-.219.938-.813 1.813-2 1.813-.719 0-1.543-.52-2-.813z" fill="#fff"/><path d="M39.613 24.77c.305 0 .91.097 1.246.68A3.77 3.77 0 0 0 41 25c-.27-.875-1.031-1-1.387-1C37.895 24 37 26 37 26c.094.059.21.133.332.203.398-.59 1.164-1.433 2.281-1.433z" fill="#37474f"/><path d="M39.375 25.188c0-.434-.246-.797-.594-1.004-.843.347-1.394 1.125-1.636 1.543.199.378.585.648 1.042.648.657 0 1.188-.531 1.188-1.188z" fill="#37474f"/><path d="M28 32s3.953 2 6 2 3-1 3-1-.922 3-4 3c-2.828 0-5-4-5-4z" fill="#e74c3c"/></svg>
                                </div>
                                <div class="item-info">
                                    <span class="item-name" title="Business Card">Girl</span>
                                </div>
                            </div>
                        </div>
                        <div class="item" data-type="animal" data-api="true">
                            <div class="main-item">
                                <div class="item-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M14 35s-2.3-14 13-14c10 0 17 8 17 8s-7.5 12-19 12c-9 0-11-6-11-6zm4-17c0-6.102-6-12-6-12s-7.3 4.3-8 13c-.7 8.7 5.8 10.7 5.8 10.7S18 26.8 18 18z" fill="#8bc34a"/><path d="M44 29s-7.5 12-19 12c-6 0-8.898-2.7-10.2-4.5-2.902 2.5-3.902 4.8-3.902 4.898-.097.403-.5.602-.898.602-.102 0-.3 0-.398-.102-.5-.199-.704-.796-.5-1.296.097-.301 2.597-5.801 10.199-9.403C30.3 25.4 44 29 44 29zm-33 6c.102 0 .2 0 .3-.102.5-.199.802-.796.598-1.296-.5-1.5-.898-2.903-1.097-4.403C13 28.2 18 24.9 18 18c0-6.102-6-12-6-12s-.398 1.102-1 3c-.2.5-5.2 13.602-.898 25.3.097.4.5.7.898.7z" fill="#689f38"/></svg>
                                </div>
                                <div class="item-info">
                                    <span class="item-name" title="Business Card">Plant</span>
                                </div>
                            </div>
                        </div>
                        <div class="item" data-type="animal" data-api="true">
                            <div class="main-item">
                                <div class="item-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M36 18c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6zm-12 0c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6z" fill="#c51162"/><path d="M36 25c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6zm-12 0c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6z" fill="#c51162"/><path d="M30 31c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6z" fill="#c51162"/><path d="M16.855 9.008c1.426.023 2.836.515 4.036 1.449 1.894 1.477 3.047 3.887 3.109 6.477v.316c-.559.586-1.95.75-2.742.75-1.461 0-2.91-.492-4.14-1.453-1.946-1.516-3.114-4.875-3.118-7.54 1.117 0 1.969-.015 2.855 0z" fill="#4caf50"/><path d="M16.855 9.012c1.426.023 2.836.515 4.036 1.453 1.894 1.476 3.047 3.887 3.109 6.476v.309L14 9.012c1.117 0 1.969-.016 2.855 0z" fill="#64dd17"/><path d="M24 17.25s4-2.203 4-7.25c0-5.047-4-8-4-8s-4 2.953-4 8c0 5.047 4 7.25 4 7.25z" fill="#64dd17"/><path d="M24 17.25s4-2.203 4-7.25c0-5.047-4-8-4-8v15.25z" fill="#4caf50"/><path d="M22.117 8.887a8.853 8.853 0 0 0-1.84-1.114 9.209 9.209 0 0 0-.27 2.106c.302.172.598.363.884.586 1.894 1.476 3.047 3.887 3.109 6.476v.309s.926-.516 1.89-1.61c-.382-2.718-1.738-5.171-3.773-6.753z" fill="#4caf50"/><path d="M31.145 9.008c-1.426.023-2.836.515-4.036 1.449-1.894 1.477-3.047 3.887-3.109 6.477v.316c.559.586 1.95.75 2.742.75 1.461 0 2.91-.492 4.14-1.45 1.946-1.519 3.114-4.878 3.118-7.542-1.117 0-1.969-.016-2.855 0z" fill="#4caf50"/><path d="M31.145 9.012c-1.426.023-2.836.515-4.036 1.453-1.894 1.476-3.047 3.887-3.109 6.476v.309l10-8.238c-1.117 0-1.969-.016-2.855 0z" fill="#64dd17"/><path d="M30 39c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6z" fill="#ff4081"/><path d="M27.117 33.883A5.92 5.92 0 0 1 28 37c0 3.313-2.688 6-6 6a5.92 5.92 0 0 1-3.117-.883A5.98 5.98 0 0 0 24 45c3.313 0 6-2.688 6-6a5.98 5.98 0 0 0-2.883-5.117z" fill="#c51162"/><path d="M24 31c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6zm12 0c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6z" fill="#ff4081"/><path d="M21.117 25.883A5.92 5.92 0 0 1 22 29c0 3.313-2.688 6-6 6a5.92 5.92 0 0 1-3.117-.883A5.98 5.98 0 0 0 18 37c3.313 0 6-2.688 6-6a5.98 5.98 0 0 0-2.883-5.117zm12 0A5.92 5.92 0 0 1 34 29c0 3.313-2.688 6-6 6a5.92 5.92 0 0 1-3.117-.883A5.98 5.98 0 0 0 30 37c3.313 0 6-2.688 6-6a5.98 5.98 0 0 0-2.883-5.117z" fill="#c51162"/><path d="M18 23c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6z" fill="#ff4081"/><path d="M9 23a3 3 0 0 1 3-3m3 11a3 3 0 0 1 3-3m9 3a3 3 0 0 1 3-3m-9 11a3 3 0 0 1 3-3" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke="#ffd9e8" stroke-miterlimit="10"/><path d="M15.117 17.883A5.92 5.92 0 0 1 16 21c0 3.313-2.688 6-6 6a5.92 5.92 0 0 1-3.117-.883A5.98 5.98 0 0 0 12 29c3.313 0 6-2.688 6-6a5.98 5.98 0 0 0-2.883-5.117z" fill="#c51162"/><path d="M30 23c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6zm12 0c0 3.313-2.688 6-6 6-3.313 0-6-2.688-6-6 0-3.313 2.688-6 6-6 3.313 0 6 2.688 6 6z" fill="#ff4081"/><path d="M27.117 17.883A5.92 5.92 0 0 1 28 21c0 3.313-2.688 6-6 6a5.92 5.92 0 0 1-3.117-.883A5.98 5.98 0 0 0 24 29c3.313 0 6-2.688 6-6a5.98 5.98 0 0 0-2.883-5.117zm12 0A5.92 5.92 0 0 1 40 21c0 3.313-2.688 6-6 6a5.92 5.92 0 0 1-3.117-.883A5.98 5.98 0 0 0 36 29c3.313 0 6-2.688 6-6a5.98 5.98 0 0 0-2.883-5.117z" fill="#c51162"/><path d="M21 23a3 3 0 0 1 3-3m9 3a3 3 0 0 1 3-3" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke="#ffd9e8" stroke-miterlimit="10"/></svg>
                                </div>
                                <div class="item-info">
                                    <span class="item-name" title="Business Card">Fruit</span>
                                </div>
                            </div>
                        </div>
                        <div class="item" data-type="animal" data-api="true">
                            <div class="main-item">
                                <div class="item-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M37.5 20h-5.297l-4.55-5.46A1.494 1.494 0 0 0 26.5 14H20c-.023 0-5.324 10.95-5.324 10.95-.453.628-.742 1.44-.676 2.05l.895 7.184-7.211 6.312a1.998 1.998 0 1 0 2.632 3.008l8-7c.493-.43.743-1.074.668-1.727l.008-4.785s.004.004.004.008l4.758 4.309 3.418 8.504a2 2 0 0 0 2.64 1.011 1.997 1.997 0 0 0 1.016-2.636l-4-9a1.943 1.943 0 0 0-.2-.352L22 26a.087.087 0 0 0-.016-.02l3.68-7.425 4.684 3.906c.285.34.707.539 1.152.539h6a1.5 1.5 0 0 0 0-3z" fill="#ffba57"/><path d="M21.973 26l5.68-11.46A1.494 1.494 0 0 0 26.5 14H20l-5.492 11.305c-.11.226-.188.46-.242.695z" fill="#9575cd"/><path d="M14.137 26c-.114.352-.172.7-.137 1v8h5v-9z" fill="#4db6ac"/><path d="M24.5 5a3.5 3.5 0 1 1 0 7 3.5 3.5 0 1 1 0-7" fill="#ffba57"/><path d="M37.5 23a3.5 3.5 0 1 1 0 7 3.5 3.5 0 1 1 0-7" fill="#f57f17"/><path d="M19.5 28c-.383 0-.77-.148-1.063-.441l-5-5a1.5 1.5 0 0 1-.09-2.02l5-6a1.5 1.5 0 1 1 2.305 1.922l-4.125 4.945 4.032 4.032a1.5 1.5 0 0 1 0 2.12c-.29.294-.676.442-1.059.442z" fill="#ffba57"/><path d="M26.629 31.836L22 26h-1.098a1.489 1.489 0 0 1-1.402 2c-.383 0-.77-.148-1.063-.441l-3.39-3.391s-.79 1.348-.926 1.902L19 30l4 5 3.828-2.813a1.943 1.943 0 0 0-.2-.351z" fill="#26a69a"/><path d="M19.234 21.285l1.418-4.824-4.125 4.945 4.032 4.032c.164.164.27.359.343.562h1.024l.648-1.367s-.379-.387-.601-.61z" fill="#7e57c2"/></svg>
                                </div>
                                <div class="item-info">
                                    <span class="item-name" title="Business Card">Sport</span>
                                </div>
                            </div>
                        </div>
                        <div class="item" data-type="animal" data-api="true">
                            <div class="main-item">
                                <div class="item-svg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path d="M42.238 39.36H36.48l-2.878 4.8-6.829-12.8a12.463 12.463 0 0 0 7.711-5.407l.075-.031zM13.516 25.952l-.075-.031-7.68 13.437h5.759l2.878 4.801 6.829-12.8a12.478 12.478 0 0 1-7.711-5.407z" fill="#673ab7"/><path d="M39.36 19.2c0 8.484-6.876 15.359-15.36 15.359-8.484 0-15.36-6.875-15.36-15.36 0-8.48 6.876-15.36 15.36-15.36 8.484 0 15.36 6.88 15.36 15.36" fill="#ffab00"/><path d="M29.094 35.71l-.926-1.737a15.342 15.342 0 0 0 7.941-5.344l1.016 1.781a17.292 17.292 0 0 1-8.031 5.3zm-10.188 0l.926-1.737a15.342 15.342 0 0 1-7.941-5.344l-1.016 1.781a17.292 17.292 0 0 0 8.031 5.3z" fill="#4527a0"/><path d="M24 6.719c-6.895 0-12.48 5.59-12.48 12.48 0 6.895 5.585 12.48 12.48 12.48 6.895 0 12.48-5.585 12.48-12.48 0-6.89-5.585-12.48-12.48-12.48zm9.29 7.457c.331.605.6 1.25.804 1.91l-1.836.562a8.665 8.665 0 0 0-.656-1.558zm-8.294-5.489l-.18 1.91a8.78 8.78 0 0 0-1.695.008l-.191-1.91c.68-.07 1.386-.074 2.066-.008zm-3.875 8.907v-1.715l3.66-1.48h.18V24h-1.922v-7.055zm-3.844-6.54l1.223 1.481c-.434.36-.836.762-1.191 1.2L15.82 12.52a10.73 10.73 0 0 1 1.457-1.465zm-2.601 3.188l1.691.903a8.641 8.641 0 0 0-.64 1.562l-1.84-.555c.199-.66.465-1.3.789-1.91zM13.44 19.2c0-.344.016-.68.047-1.015l1.91.18a10.06 10.06 0 0 0-.039.835c0 .29.016.578.043.863l-1.91.188c-.035-.344-.05-.695-.05-1.05zm1.25 4.988a10.493 10.493 0 0 1-.796-1.91l1.84-.558c.163.539.378 1.066.648 1.562zm2.614 3.18a10.757 10.757 0 0 1-1.461-1.46l1.48-1.22c.36.438.762.84 1.2 1.196zm3.597-18.265l.563 1.835a8.377 8.377 0 0 0-1.559.653l-.914-1.692c.61-.324 1.25-.593 1.91-.796zm.035 20.207a10.799 10.799 0 0 1-1.914-.793l.907-1.692c.496.266 1.02.48 1.562.645zm3.063.453c-.348 0-.695-.02-1.035-.051l.183-1.91c.559.05 1.137.054 1.696 0l.183 1.91c-.336.031-.68.05-1.027.05zm3.027-20.68c.66.195 1.305.461 1.914.781l-.898 1.7a8.514 8.514 0 0 0-1.566-.641zm.032 20.227l-.555-1.836a8.79 8.79 0 0 0 1.562-.649l.903 1.696a10.6 10.6 0 0 1-1.91.789zm3.605-18.301a10.59 10.59 0 0 1 1.469 1.457l-1.48 1.223a8.67 8.67 0 0 0-1.204-1.192zm.027 16.363l-1.218-1.484c.437-.36.84-.762 1.199-1.196l1.48 1.22a10.772 10.772 0 0 1-1.46 1.46zm2.614-3.176l-1.692-.91c.27-.5.489-1.023.653-1.558l1.836.558c-.2.656-.47 1.3-.797 1.91zm-.707-4.129c.027-.285.043-.574.043-.867a9.1 9.1 0 0 0-.043-.863l1.91-.188c.035.344.05.696.05 1.051 0 .356-.015.707-.05 1.055z" fill="#ffcc80"/></svg>
                                </div>
                                <div class="item-info">
