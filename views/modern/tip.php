<div class="nbd-tip" id="nbd-tip">
    ...
    <div class="tip-content">
        <div class="tip-content-inner">
            <p>- <?php _e('Double click to edit text', 'web-to-print-online-designer'); ?>
            </p>
            <p>- <?php _e('Right click on selected layers to show context menu', 'web-to-print-online-designer'); ?>
            </p>
        </div>
