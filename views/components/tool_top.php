...
<!--    <span id="mobile" ng-show="modeMobile" class="fa fa-eye shadow hover-shadow"></span>-->
    ...
    <span class="shadow hover-shadow nbd-tooltip-i18n custom-dimension active" id="custom-dimension-tg" data-toggle="modal" data-target="#dg-custom-dimension" data-lang="DIMENSION" data-placement="left" ng-show="productOptions.allow_specify_dimension == 1">
