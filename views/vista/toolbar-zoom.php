    ...
    <div class="zoomer">
        <div class="zoomer-toolbar">
            <ul class="nbd-main-zoomer">
                <li class="zoomer-item zoomer-fullscreen" ng-click="enableFullScreenMode()"><i class="nbd-icon-vista nbd-icon-vista-fullscreen"></i></li>
                <li class="zoomer-item zoomer-out" ng-click="zoomStage(stages[currentStage].states.currentScaleIndex - 1)" ng-class="stages[currentStage].states.currentScaleIndex > 0 ? '' : 'nbd-disabled'"><i class="nbd-icon-vista nbd-icon-vista-remove"></i></li>
                ...
                <li ng-click="zoomStage(stages[currentStage].states.currentScaleIndex + 1)" ng-class="stages[currentStage].states.currentScaleIndex < (stages[currentStage].states.scaleRange.length - 1) ? '' : 'nbd-disabled'" class="menu-item zoomer-item zoomer-in"><i class="nbd-icon-vista nbd-icon-vista-add-black"></i></li>
            </ul>
        </div>
    </div>
</div>